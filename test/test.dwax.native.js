...
var dwax = tryRequire( resolve( __dirname, './../lib/dwax.native.js' ) );
var opts = {
	'skip': ( dwax instanceof Error )
};
...
tape( 'the function has an arity of 6', opts, function test( t ) {
	t.strictEqual( dwax.length, 6, 'has expected arity' );
	t.end();
});
